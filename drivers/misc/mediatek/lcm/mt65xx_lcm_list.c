...
#if defined(NT51021B_WSVGA_DSI_VDO_INNOLUX)
	&nt51021b_wsvga_dsi_vdo_innolux_lcm_drv,
#endif

#if defined(HX8394D_WSVGA_DSI_VDO_GUANZHEN)
	&hx8394d_wsvga_dsi_vdo_guanzhen_lcm_drv,
#endif

//add hx8394f lcm 2016.3.11
#if defined(HX8394F_DSI_VDO)
	&hx8394f_dsi_vdo_lcm_drv,
#endif

#if defined(ILI9881C_DSI_VDO)
	&ili9881c_dsi_vdo_lcm_drv,
#endif
