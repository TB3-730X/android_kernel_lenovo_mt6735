/*
 * BU64297AF voice coil motor driver
 *
 *
 */
...
#define USE_ISRC_MODE_S5K2P8_SENSOR   //bug 156292 lens have noise 
...
static int s4AF_ReadReg(unsigned short *a_pu2Result)
{
    ...
    *a_pu2Result = (((u16)pBuff[0] & 0x03) << 8) + (pBuff[1]);	// pBuff[0] = PS EN W2 W1 W0 M D9 D8; pBuff[1] = D[7:0]
    ...
    printk("s4AF_ReadReg BU64297AF_DRV\n");
	return 0;
}
...
{
	int i4RetValue = 0;
	char puSendCmd[2]={0,0};
	#ifdef USE_ISRC_MODE_S5K2P8_SENSOR
       //	LOG_INF("gaoyangyang add Init Code_Write %ld\n", (unsigned long)a_u2Data);
          ////bug 156292 lens have noise 
	 puSendCmd[0] = (char)(((a_u2Data >> 8) & 0x03) | 0xC4);
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	LOG_INF("gaoyangyang add move [curr] %ld\n", g_u4CurrPosition);
	LOG_INF("gaoyangyang add move [Targ] %ld\n", g_u4TargetPosition);
...
/* ////////////////////////////////////////////////////////////// */
long BU64297AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int BU64297AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void BU64297AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
