...
void PMIC_INIT_SETTING_V1(void)
{
	...
	if (is_ext_buck_exist() == 1) {
		...
		//ret = pmic_config_interface(0xF4A, 0xB, 0xF, 4); //disable by guanyuwei
		...
		ret = pmic_config_interface(0x4D2, 0x1, 0x1, 0); //+Other_platform_add xuji.wt ADD 20160122 add turnoff VLTE
	} else {
