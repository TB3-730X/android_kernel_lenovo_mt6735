...
void ncp1854_set_otg_bst_msk(unsigned int val)
{
	unsigned int ret = 0;
...
unsigned int ncp1854_set_otg_vobstol1(void)
{
...
void ncp1854_set_otg_reset(void)
{
	ncp1854_set_otg_bst_msk(0); 
	ncp1854_set_int_mask(0);
    if(ncp1854_get_faultint()==1)
    	{
    if(ncp1854_set_otg_vobstol1()==1)
    	{
