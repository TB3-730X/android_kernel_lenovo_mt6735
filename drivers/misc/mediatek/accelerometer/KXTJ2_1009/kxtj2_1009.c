       ...
       unsigned long arg)
{
	...
	case COMPAT_GSENSOR_IOCTL_READ_SENSORDATA:
        ...
        case COMPAT_GSENSOR_SET_ACC_MODE:
            ...
            err = file->f_op->unlocked_ioctl(file, GSENSOR_SET_ACC_MODE, (unsigned long)arg32);
            if (err){
        ...
        case COMPAT_GSENSOR_IOCTL_SET_CALI_NEW:
            ...
            err = file->f_op->unlocked_ioctl(file, GSENSOR_IOCTL_SET_CALI_NEW, (unsigned long)arg32);
            if (err){
