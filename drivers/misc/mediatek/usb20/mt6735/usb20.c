...
struct task_struct *otg_thread_reset = NULL;

//extern void ncp1854_set_otg_reset();
extern void ncp1851_set_otg_reset(void);
extern void ncp1854_set_otg_reset(void);

static int otg_test_thread(void *data)
{
	...
	while(1)
	{
		...
		ncp1851_set_otg_reset();
#elif defined(CONFIG_MTK_NCP1854_SUPPORT)
		ncp1854_set_otg_reset();
#else
		break;
#endif
	}
...
#endif
	kthread_run(otg_test_thread, NULL, "otg_test_thread");
