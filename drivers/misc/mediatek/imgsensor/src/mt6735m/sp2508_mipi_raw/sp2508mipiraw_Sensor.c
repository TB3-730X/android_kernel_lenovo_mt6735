...
//#define LOG_INF(format, args...)    xlog_printk(PFX, "[%s] " format, __FUNCTION__, ##args)
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SP2508_MIPI_RAW_SENSOR_ID,
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,// B   RGB  direction zjm
...
{    
	...
	//add digital gain 1.377x������������� 20150515
	{
	write_cmos_sensor(0xfd,0x01);
	write_cmos_sensor(0x3f,0x00);//0x03-->R  0x00--->B       direction zjm
	...
	write_cmos_sensor(0x25,0xf0); //reg dac 2.7v, enable bl_en,vbl 1.28v ԭΪ0xf2 ��Ϊ0xf0 ����̫������滻��ѹ
	...
	write_cmos_sensor(0x8a,0x44); //pixel bias 1.58uA ԭΪ0x55 ��Ϊ0x44 ����pixel bias
	write_cmos_sensor(0x8b,0x44); //ԭΪ0x55 ��Ϊ0x44 ����pixel bias
