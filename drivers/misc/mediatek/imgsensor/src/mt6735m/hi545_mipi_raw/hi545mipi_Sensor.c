...
//#define HI545Oflim_DEBUG

#ifdef HI545Oflim_DEBUG
...
#define HI545OFLIM_USE_AWB_OTP
#ifdef HI545OFLIM_USE_AWB_OTP
...
static struct HI545Oflim_USE_AWB_OTP current_otp = {0};
#if 0
...
static void Hi545_Sensor_update_wb_gain(struct HI545Oflim_USE_AWB_OTP *otp)
{
    kal_uint16 rg,bg;
...
static void  Hi545_Sensor_calc_wbdata(struct HI545Oflim_USE_AWB_OTP *otp)
{
    uint16_t wbcheck = 0, 
			 checksum = 0, 
			 wb_flag = 0;
