...
#include "s5k3m2mipi_Sensorv2.h"
#include "s5k3m2_pdafotpv2.h"

#define PFX "S5K3M2V2_camera_sensor"
...
#define S5K3M2V2_OTP_FUNCTION


static DEFINE_SPINLOCK(imgsensor_drv_lock);
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K3M2_V2_SENSOR_ID,
...
#ifdef  S5K3M2V2_OTP_FUNCTION
	LOG_INF("S5K3M2 OTP start \n");
	S5K3M2V2_Otp_Info();
	if(ModuleHouseID != 0x0C){
              *sensor_id = 0xFFFFFFFF;
               return ERROR_SENSOR_CONNECT_FAIL;
	}
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			read_3m2_eeprom_v2((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;			
...
UINT32 S5K3M2V2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
