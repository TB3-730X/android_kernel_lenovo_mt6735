...
// sensor id = 0x0
#define MAX_LIMIT_VALUE_GROUP1  7000	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 1407		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 3236		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 1435		// key_val min limit
#define UNIFORMITY_GROUP1 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
  0x00,0x58,0x02,0x00,0x04,0x05,0x05,0xC0,0x01,0x08,\
  0x28,0x08,0x4B,0x3C,0x03,0x05,0x00,0x00,0x00,0x00,0x00,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x8D,0x2D,0x0F,0x4B,\
  0x4D,0x0C,0x08,0x00,0x00,0x00,0x02,0x03,0x1D,0x00,\
  0x01,0x00,0x00,0x00,0x03,0x64,0x32,0x00,0x00,0x00,\
  0x23,0x5A,0x94,0x45,0x02,0x07,0x00,0x00,0x04,0x9B,\
  0x26,0x00,0x87,0x2E,0x00,0x77,0x38,0x00,0x6A,0x44,\
  0x00,0x60,0x52,0x00,0x60,0x00,0x00,0x00,0x00,0x00,0x00,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1C,0x1A,0x18,\
  0x16,0x14,0x12,0x10,0x0E,0x0C,0x0A,0x08,0x06,0x04,0x02,\
  0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,\
  0xFF,0xFF,0xFF,0xFF,0xFF,0x24,0x23,0x25,0x22,0x26,0x21,\
  0x27,0x20,0x28,0x1F,0x29,0x1E,0x2A,0x06,0x0C,0x05,0x0B,0x04,\
  0x0A,0x03,0x09,0x02,0x08,0x01,0x07,0x00,0x00,0x00,0x00,0x00,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0A,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xB4,0x00,\
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
  0x00,0x00,0xF4,0x01\
    }
...
//sensor id =0x08
#define MAX_LIMIT_VALUE_GROUP2 7000 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP2 600		// screen min limit
#define MAX_LIMIT_KEY_GROUP2 3236		// key_val max limit
#define MIN_LIMIT_KEY_GROUP2 1435		// key_val min limit
...
#define MAX_LIMIT_VALUE_GROUP3 8000	// screen max limit
#define MIN_LIMIT_VALUE_GROUP3 1000	// screen min limit
#define MAX_LIMIT_KEY_GROUP3 3236		// key_val max limit
#define MIN_LIMIT_KEY_GROUP3 1435		// key_val min limit
#define UNIFORMITY_GROUP3 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP3 {\
	 \
    }

//TODO: define your config for Sensor_ID == 3 here, if needed

//HuaRuichuan
#define MAX_LIMIT_VALUE_GROUP4 3279 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP4 1059		// screen min limit
#define MAX_LIMIT_KEY_GROUP4 2522		// key_val max limit
#define MIN_LIMIT_KEY_GROUP4 894		// key_val min limit
...
0x1E,0x0A,0x50,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8B,0x2B,0x0C,\
0x32,0x34,0xD3,0x07,0x00,0x00,0x00,0x03,0x32,0x1D,\
0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x32,0x00,0x00,\
0x02,0x1E,0x50,0x94,0x55,0x02,0x00,0x00,0x00,0x04,\
0xB8,0x21,0x00,0x9B,0x28,0x00,0x82,0x31,0x00,0x6F,\
0x3B,0x00,0x5E,0x48,0x00,0x5E,0x18,0x38,0x50,0x00,\
0x58,0x4A,0x3A,0xFF,0xFF,0x27,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1E,0x20,0x00,\
0x46,0x46,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,\
0x12,0x14,0x16,0x18,0xFF,0xFF,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFF,0x0F,\
0xFF,0x00,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0F,\
...
//Yeji
#define MAX_LIMIT_VALUE_GROUP6 2091 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP6 892		// screen min limit
#define MAX_LIMIT_KEY_GROUP6 1684		// key_val max limit
#define MIN_LIMIT_KEY_GROUP6 785		// key_val min limit
#define UNIFORMITY_GROUP6 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP6 {\
0x00,0xD0,0x02,0x00,0x05,0x05,0x05,0x01,0x01,0x08,\
0x1E,0x0A,0x50,0x32,0x03,0x05,0x00,0x00,0xFF,0x7F,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8B,0x2B,0x0C,\
0x32,0x34,0xD3,0x07,0x03,0x0A,0x00,0x03,0x22,0x1D,\
0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x32,0x00,0x00,\
0x1B,0x1E,0x50,0x94,0x45,0x02,0x00,0x07,0x00,0x04,\
0xBA,0x21,0x00,0x9C,0x28,0x00,0x82,0x31,0x00,0x6E,\
0x3B,0x00,0x5C,0x48,0x00,0x5C,0x18,0x38,0x50,0x00,\
0x58,0x4A,0x3A,0xFF,0xFF,0x27,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0F,\
0x0F,0x03,0x06,0x10,0x54,0xBA,0x0F,0x19,0x20,0x00,\
0x50,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,\
0x12,0x14,0x16,0x18,0xFF,0xFF,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x16,0x18,0x1C,0x1D,0x1E,0x1F,0x20,0x21,\
0x22,0x24,0x26,0x13,0x12,0x10,0x0F,0x0C,0x0A,0x08,\
0x06,0x04,0x02,0x00,0xFF,0xFF,0xFF,0xFF,0x00,0x00,\
0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,\
0xFF,0xFF,0xFF,0xFF,0x31,0x01\
    }
...
*******************************************************/
void Ctp_CmcsTest_Proc_init(void)
{

    gtp_parent_proc= proc_mkdir(GTP_TEST, NULL);
    if(gtp_parent_proc == NULL)
    {
	   GTP_INFO("GT9293: create parent_proc fail\n");
     }
