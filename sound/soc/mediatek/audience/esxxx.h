...
struct esxxx_platform_data {
	...
	unsigned int	gpio_a_interrupts;
	unsigned int	gpio_b_irq_type;
	unsigned int	gpio_b_interrupts;
	int	reset_gpio;
	int	wakeup_gpio;
	int	gpioa_gpio;
	int	gpiob_gpio;
	...
	int	spi_wdb_speed;
	struct pinctrl *es_pinctrl;
	struct pinctrl_state *pins_es_pins_mode0;
	struct pinctrl_state *pins_es_pins_mode1;
};
