...
static int es705_i2c_write_block(struct i2c_client *client, u8 addr,
                u8 *data, u8 len)
{
    /*
...
static const struct i2c_device_id escore_i2c_id[] = {
	{ "earSmart-codec-i2c", 0},
	{ }
};
MODULE_DEVICE_TABLE(i2c, escore_i2c_id);

#ifdef CONFIG_OF
static const struct of_device_id es814_i2c_of_ids[] = {
    {.compatible = "mediatek,es814_i2c",},
    {}
};
#endif
...
struct i2c_driver escore_i2c_driver = {
	.driver = {
		.name = "earSmart-codec-i2c",
		.owner = THIS_MODULE,
#ifdef CONFIG_OF
		.of_match_table = es814_i2c_of_ids,
#endif
		.pm = &escore_pm_ops,
	},
